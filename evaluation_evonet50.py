...
checkpoint_path = "./Baseline/evo_omniimage/evonet50_omniimage_100k-epoch_1e-3-lr_1000-evo-interval.pth"
...
test_sampler = OmniImageTaskSampler(
    root=DATA_ROOT, n_way=N_way_test, k_shot=K_shot, n_query=N_query, split='test'
)
...
print(f"EvoNet50 ProtoNet Accuracy: {correct / total:.4f} ({correct / total * 100:.2f}%)")
